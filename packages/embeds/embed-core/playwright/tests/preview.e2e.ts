...
test.describe("Preview", () => {
  test("Preview - embed-core should load if correct embedLibUrl is provided", async ({ page }) => {
    await page.goto(
      "https://cal.log1.com/embed/preview.html?embedLibUrl=https://cal.log1.com/embed/embed.js&bookerUrl=https://cal.log1.com&calLink=pro/30min"
    );
  ...
  test("Preview - embed-core should load from embedLibUrl", async ({ page }) => {
    ...
    page.goto(
      "https://cal.log1.com/embed/preview.html?embedLibUrl=https://cal.log1.com/embed/embed-not-found.js&bookerUrl=https://cal.log1.com&calLink=pro/30min"
    );
    ...
    expect(failedRequestUrl).toBe("https://cal.log1.com/embed/embed-not-found.js");
  });
});
